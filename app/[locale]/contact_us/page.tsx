            ...
            >
              <h2 className="text-2xl font-bold mb-6 text-center">
                ...
                />
                    ...
                    <select className="w-[30%] bg-black text-white border border-white/30 px-2 py-2 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-[#b70501]">
                      <option className="bg-black text-white">+20</option>
                      <option className="bg-black text-white">+966</option>
                      <option className="bg-black text-white">+971</option>
                      <option className="bg-black text-white">+965</option>
                      <option className="bg-black text-white">+973</option>
                      <option className="bg-black text-white">+974</option>
                      <option className="bg-black text-white">+968</option>
                      <option className="bg-black text-white">+963</option>
                      <option className="bg-black text-white">+962</option>
                      <option className="bg-black text-white">+964</option>
                  ...
                  >
                    ...
                    <option value="بنت هاوس">بنت هاوس</option>
