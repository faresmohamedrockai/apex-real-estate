...
export default function DashboardPage() {
  ...
  return (
    <div dir="rtl" className="flex min-h-screen w-full bg-gradient-to-br from-neutral-900 via-neutral-800 to-neutral-900 text-white">
      <Sidebar
        items={sidebarItems}
        selected={selected}
      ...
      >
        {/* Header محسن */}
        <div className="bg-gradient-to-r from-[#b70501]/10 to-transparent backdrop-blur-sm border-b border-white/10 p-8 md:p-12">
